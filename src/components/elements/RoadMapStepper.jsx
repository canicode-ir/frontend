...
const steps = [
  ...
  },
  {
    ...
    label: "قدم سوم: سطح سنیور (متخصص فرانت)",
    description:
      "در نهایت هم می ریم سراغ آموزش یک ابر قهرمان در حوزه فرانت به نام NextJs. نکست یک فریم وورک از ریکت هستش که یکسری از ضعف های ریکت رو پوشش میده؛ مثل SEO کردن سایت. همچنین در این سطح، فریم وورک استایل دهی پیشرفته Tailwind و همچنین استفاده از Material UI رو که کامپوننت های آماده داره آموزش می بینیم.",
  },
];
    ...
    >
      <Paper
        ...
        sx={{
          ...
          bgcolor: `${
            steps[activeStep].level === "starter"
              ? "#eab308"
              : steps[activeStep].level === "mid-level"
              ? "#0284c7"
              : "#1f2937"
          }`,
        }}
      >
        <Typography sx={{ fontWeight: "90" }}>
      ...
      <MobileStepper
        ...
        nextButton={
          <Button
            sx={{ fontFamily: "dana", fontWeight: "110", color: "#3730a3" }}
            size="small"
            onClick={handleNext}
