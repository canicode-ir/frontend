...
const steps = [
  ...
  {
    label: "بهره برداری | شهریور 1403",
    description: `با توجه به روند پیشرفت کارهای اجرایی، پیش بینی خودمون این هست که تا شهریور 1403، این استارتاپ به بهره برداری برسه و بریم سراغ داستان جذاب این آکادمیِ آموزشی و اجرایی.`,
  },
];
