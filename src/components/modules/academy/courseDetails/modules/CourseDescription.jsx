    ...
    },
    {
      ...
      advantages: [
        ...
        },
        {
          ...
          description:
            "هر هفته وبینار ها آنلاین داریم که در این وبینار لایو کد انجام میدیم و همچنین با افراد متخصص در حوزه های دیگر مثل UI/UX، بک اند، دیتابیس و سایر حوزه های مرتبط با کارمون جلساتی برگزار میکنیم تا شما به درک بهتر و عمیق تری از نوع ارتباط بین حوزه های مختلف برنامه نویسی دست پیدا کنید..",
        },
        {
          id: "Education",
