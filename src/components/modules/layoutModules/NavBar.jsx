...
export default function ButtonAppBar() {
  ...
  const navItems = [
    ...
    {title: 'aboutus', name: 'درباره ما' , url: '/aboutus', icon: <Diversity2Icon />},
    {title: 'academy', name: 'دوره ها آموزشی' , url: '/academy', icon: <SchoolIcon />},
    {title: 'projects', name: 'فرم درخواست همکاری' , url: '/cooperation', icon: <WorkspacesIcon />},
    {title: 'contactus', name: 'تماس با ما' , url: '/contact', icon: <ContactSupportIcon />},
    {title: 'articles', name: 'مقالات آموزشی' , url: '/articles', icon: <NewspaperIcon />},
  ]
