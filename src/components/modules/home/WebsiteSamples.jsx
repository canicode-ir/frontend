  ...
  return (
    <div className='flex flex-col justify-center items-center mt-20 px-6
        ...
        <Box sx={{ flexGrow: 1, p: '30px 30px 5px', borderRadius: '18px', m: '30px auto 0',
            ...
            >
                <Typography variant='h6' component='h6' sx={{fontWeight: '80', fontSize: '12px', 
                bgcolor: `${images[activeStep].devMode === 'js' ? '#facc15' : images[activeStep].devMode === 'reactjs' ? '#38bdf8' : '#374151'}`,
                color: '#fefefe', borderRadius: '10px', p: 1, '@media (min-width: 390px)' : {fontSize: '14px'},
                '@media (min-width: 420px)' : {fontSize: '15px'}, '@media (min-width: 500px)' : {fontSize: '18px'}}}>{images[activeStep].label}</Typography>
            </Paper>
